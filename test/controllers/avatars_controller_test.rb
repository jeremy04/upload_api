...
class AvatarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avatar" do
    assert_difference('Avatar.count') do
      post avatars_url, params: { avatar: { photo_data: @avatar.photo_data, title: @avatar.title } }, as: :json
    end
  ...
  test "should update avatar" do
    patch avatar_url(@avatar), params: { avatar: { photo_data: @avatar.photo_data, title: @avatar.title } }, as: :json
    assert_response 200
  end
